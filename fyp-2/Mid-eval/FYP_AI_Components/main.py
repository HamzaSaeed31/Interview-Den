...
try:
    ...
    print(f"⚠️ Warning: Could not import Part3 modules. Interview pipeline will fail: {e}")
...
try:
    ...
    print(f"⚠️ Warning: Could not import Part1/Part2 modules. API logic may fail: {e}")
